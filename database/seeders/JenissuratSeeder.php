...
class JenissuratSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('jenissurats')->insert([
            ...
            ['namaJenisSurat' => 'Surat Domisili', 'deskripsi' => 'Surat Domisili adalah dokumen resmi yang dikeluarkan oleh pemerintah setempat, seperti kantor kelurahan atau desa, yang menyatakan bahwa seseorang tinggal atau berdomisili di wilayah tertentu. Surat ini biasanya diperlukan untuk berbagai keperluan administratif, seperti pendaftaran sekolah, pembuatan kartu identitas, pengajuan kredit, atau keperluan lainnya yang memerlukan bukti tempat tinggal.', 'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()],

            ['namaJenisSurat' => 'Surat Dispensasi Waktu', 'deskripsi' => 'Surat Dispensasi Waktu adalah dokumen resmi yang dikeluarkan oleh suatu instansi, organisasi, atau lembaga pendidikan yang memberikan izin khusus kepada individu untuk tidak mengikuti kegiatan atau kewajiban tertentu pada waktu yang telah ditentukan. Dispensasi waktu ini biasanya diberikan karena adanya alasan khusus atau keadaan darurat yang memerlukan kebijakan khusus.', 'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()],

            ['namaJenisSurat' => 'Surat Kelahiran', 'deskripsi' => 'Surat Kelahiran adalah dokumen resmi yang dikeluarkan oleh instansi pemerintah, seperti kantor catatan sipil atau dinas kependudukan dan pencatatan sipil, yang mencatat kelahiran seorang anak. Surat ini merupakan bukti hukum mengenai kelahiran anak dan mencakup informasi penting tentang identitas anak serta orang tuanya.', 
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()],

            ['namaJenisSurat' => 'Surat Permohonan Akta', 'deskripsi' => 'Surat Permohonan Akta adalah dokumen resmi yang digunakan untuk mengajukan permohonan penerbitan atau perubahan akta tertentu kepada instansi yang berwenang, seperti kantor catatan sipil atau dinas kependudukan dan pencatatan sipil. Akta yang dimaksud bisa berupa akta kelahiran, akta perkawinan, akta perceraian, akta kematian, atau akta pengakuan anak. ', 
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()],

            ['namaJenisSurat' => 'Surat Permohonan Penduduk', 'deskripsi' => 'Surat Permohonan Penduduk adalah dokumen resmi yang diajukan oleh seorang warga kepada instansi pemerintah, seperti kantor kelurahan atau dinas kependudukan dan pencatatan sipil, untuk keperluan tertentu yang berhubungan dengan status kependudukan. ', 
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()],

            ['namaJenisSurat' => 'Surat Permohonan Cerai', 'deskripsi' => 'Surat Permohonan Cerai adalah dokumen resmi yang diajukan oleh salah satu pasangan yang ingin mengajukan perceraian ke Pengadilan Agama (bagi yang beragama Islam) atau Pengadilan Negeri (bagi yang beragama lain). Surat ini mencakup alasan perceraian, data lengkap kedua belah pihak, dan permohonan resmi untuk memproses perceraian tersebut.', 
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()],

            ['namaJenisSurat' => 'Surat Undangan', 'deskripsi' => 'Surat Undangan adalah dokumen resmi yang digunakan untuk mengundang seseorang atau sekelompok orang untuk menghadiri suatu acara, pertemuan, atau kegiatan tertentu.', 
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()],
